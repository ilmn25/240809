...
public class GameSystem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("map_system").GetComponent<MapYCullSystem>().ForceRevertMesh();
            _player.transform.position = CustomLibrary.AddToVector(_player.transform.position, 0, 200, 0);
        }

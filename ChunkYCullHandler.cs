...
public class ChunkYCullHandler : MonoBehaviour
{  
    ...
    void Awake()
    {   
        CULL_DISTANCE= ChunkSystem.CHUNKSIZE * CULL_DISTANCE;
        _mesh = new Mesh();    

        _player = GameObject.Find("player");
        _mapYCullSystem = transform.parent.GetComponent<MapYCullSystem>();  
    ...
    {  
        ...
        shadowMeshRenderer.material = BlockSystem._shadowMeshMaterial; 
    }
    ...
    {   
        ...
        while (Time.frameCount < _mapYCullSystem._cullSyncFrame) await Task.Yield();
        
        if (_mapYCullSystem._yCheck) _meshFilter.mesh = _mesh; 
    ...
    bool HandleRangeCheck()
    {
        try
        { 
            chunkPosition = ChunkSystem._chunkPosition;
    ...
    void HandleCullMath()
    {
        ...
        { 
            ...
            yThreshold = _mapYCullSystem._yThreshold,

...
/// <summary>A crazed heretic wielding a fast dagger. Like the congregant, it
/// aggroes on sight and chases the player, but its dagger is quick and short-range.</summary>
public class HereticMachine : GroundMobMachine
{
    ...
    public override void OnStart()
    {
        ...
        Info.SetEquipment(new ItemSlot(ID.Dagger));
    }

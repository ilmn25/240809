...
public class MobSpawner
{
    ...
    private static readonly List<ID> NightMobs = new() { ID.SnareFlea, ID.Raider, ID.Congregant, ID.Acolyte, ID.Bear, ID.Watchdog, ID.TreeMimic, ID.Mannequin, ID.Vampire };

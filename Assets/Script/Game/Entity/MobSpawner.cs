...
public class MobSpawner
{
    ...
    private static readonly List<ID> NightMobs = new() { ID.SnareFlea, ID.Raider, ID.Congregant, ID.Acolyte, ID.Heretic, ID.Cultist, ID.Bear, ID.Watchdog, ID.TreeMimic, ID.Mannequin, ID.Vampire, ID.Sawblade };

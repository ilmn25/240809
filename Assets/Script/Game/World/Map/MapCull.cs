...
{ 
    ...
    static void HandleObstructionCheck()
    {
        ...
        Vector3 cameraPosition = _playerPosition +  (Quaternion.Euler(0, CameraSingleton._orbitRotation, 0) * new Vector3(0, CameraSingleton.DISTANCE, -CameraSingleton.DISTANCE));

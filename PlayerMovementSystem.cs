...
{ 
    ...
    { 
        ...
        _playerAnimationSystem = GetComponent<PlayerAnimationSystem>();
    }
    ...
    public void HandleInput()
    {
        ...
        orbitRotation = Mathf.Deg2Rad * -CameraSystem._orbitRotation;
    ...
    { 
        ...
        _playerAnimationSystem.HandleAnimationUpdate(); 
    }
    ...
    {  
        ...
        _deltaTime = GameSystem.GetDeltaTime();
    ...
    //     Collider[] tempArray = new Collider[1]; 
    //     int numColliders = Physics.OverlapCapsuleNonAlloc(_newPosition + _collider[0], _newPosition + _collider[1], _colliderRadius, tempArray, _collisionLayer);

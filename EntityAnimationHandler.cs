...
public class EntityAnimationHandler : MonoBehaviour
{
    ...
    public void HandleAnimationUpdate()
    {
        ...
        _relativeDirection = new Vector2(_entityMovementHandler._direction.x, _entityMovementHandler._direction.z);  
        ...
        { 
            ...
            _relativeDirection = CameraSystem.GetRelativeDirection(_relativeDirection); 
            _animator.SetFloat("PosX", _relativeDirection.x);
            _animator.SetFloat("PosY", _relativeDirection.y);
        }

        isMoving = _entityMovementHandler._speedCurrent > 0.35 && _entityMovementHandler._isGrounded;
        ...
        if (isMoving)
        {
            ...
            {
                SmokeParticleSystem.CreateSmokeParticle(transform.position, false);
